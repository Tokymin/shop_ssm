...
import com.toky.shop.service.OrderService;
...
public class CustomerController {
    ...
    public Msg saveInfo(String name, String email, String telephone, HttpServletRequest request){
        ...
        else  {return com.toky.shop.pojo.Msg.fail("更新失败");}
    }
    ...
    @ResponseBody
    public com.toky.shop.pojo.Msg saveAddr(Address address){

        addressService.updateByPrimaryKeySelective(address);
        return com.toky.shop.pojo.Msg.success("修改成功");
    }

    @RequestMapping("/deleteAddr")
    @ResponseBody
    public com.toky.shop.pojo.Msg deleteAddr(Address address){
    ...
    @ResponseBody
    public com.toky.shop.pojo.Msg insertAddr(Address address, HttpServletRequest request){
       ...
       address.setUserid(user.getUserid());
        ...
        return com.toky.shop.pojo.Msg.success("添加成功");
    }
   ...
   /* @RequestMapping("/info/list")
    ...
    @ResponseBody
    public com.toky.shop.pojo.Msg deleteList(Order order){
    ...
    @ResponseBody
    public com.toky.shop.pojo.Msg savePsw(String Psw, HttpServletRequest request)
    {
        HttpSession session=request.getSession();
        User user=(User) session.getAttribute("user");
        user.setPassword(Psw);
        userService.updateByPrimaryKeySelective(user);
        return com.toky.shop.pojo.Msg.success("修改密码成功");
    }

    @RequestMapping("/finishList")
    @ResponseBody
    public com.toky.shop.pojo.Msg finishiList(Integer orderid){
        Order order=orderService.selectByPrimaryKey(orderid);
        order.setIsreceive(true);
        order.setIscomplete(true);
        orderService.updateOrderByKey(order);
        return com.toky.shop.pojo.Msg.success("完成订单成功");
    }
