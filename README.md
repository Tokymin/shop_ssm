...
在国家精准扶贫的号召下，xxxx大学帮扶兴国县、崇贤乡、崇义村在学校内开办“扶贫超市”，帮助贫困农户和其他村民的农特产品。既解决了贫困户的销售担忧，也满足了学校师生对生态农特产品的需求，更体现了老师的爱心消费观念，让老师与农户有了心与心的贴近。
...
项目使用了MySQL数据库，这是一款开源免费且小型的关系型数据库，MySQL未必是功能最强大的数据库，但是因为其速度、可靠性和适应性却受到广大开发者的青睐。在不需要事务化处理的情况下，MySQL也是管理内容最好的选择。由于本项目只面向xxx大学的师生提供超市物品的购买服务，因此使用MySQL数据库不失为一种好的选择。
...
本组共两名人员，其中组长1人xx，组员1人xx，分别担任后台以及前端的工作，其完整分工如表1-1所示。

表1-1 小组分工

| **成员** | **职务** | **任务**                                              |
|----------|----------|-------------------------------------------------------|
| xx     | 组长     | ①项目功能设计 ②后台项目配置 ③数据库设计 ④接口编写     |
| xxx   | 组员     | ①项目功能设计 ②前端页面搭建 ③JS逻辑代码编写 ④UI、作图 |
